...
export function FollowButton({ projectId, initiallyFollowed }: { projectId: string; initiallyFollowed: boolean }) {
  ...
  return (
    <button
      ...
      disabled={pending}
      title={followed ? "Siguiendo — clic para dejar de seguir" : "Seguir este proyecto"}
